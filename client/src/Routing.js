...
import {Openings, MiddleGame, Endgame} from './pages/links.js'
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/learn" element={<ProtectedRoute><Sidebar/><Learn/></ProtectedRoute>}/>
                <Route path="/openings" element={<ProtectedRoute><Sidebar/><Openings/></ProtectedRoute>}/>
                <Route path="/middlegame" element={<ProtectedRoute><Sidebar/><MiddleGame/></ProtectedRoute>}/>
                <Route path="/endgame" element={<ProtectedRoute><Sidebar/><Endgame/></ProtectedRoute>}/>
